...
namespace PizzaStore.Web.Pages
{
	public class DeletePizzaModel : PageModel
	{
		...
		public DeletePizzaModel(IHttpClientFactory httpClientFactory) => _httpClientFactory = httpClientFactory;
		...
		public async Task<IActionResult> OnPost()
		{
			...
			using HttpResponseMessage response = await httpClient.DeleteAsync($"/pizzas/{PizzaModels.Id}");
